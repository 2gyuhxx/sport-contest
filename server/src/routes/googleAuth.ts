...
const getGoogleClient = () => {
  ...
  const redirectUri = process.env.GOOGLE_REDIRECT_URI || 'https://wherehani.com/auth/google/callback'
...
router.get('/google', (req, res) => {
  try {
    ...
    console.log('리다이렉트 URI:', process.env.GOOGLE_REDIRECT_URI || 'https://wherehani.com/auth/google/callback')
